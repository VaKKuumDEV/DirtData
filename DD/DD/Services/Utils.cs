...
namespace DD.Services
{
    public class Utils
    {
        ...
        {
            return PostRequest(url, new Dictionary<string, object>());
        }

        public static string PostRequest(string url, Dictionary<string, object> pars)
        {
            ...
            foreach (var kv in pars)
            {
                if (kv.Value.GetType() == typeof(FileInfo))
                {
                    ...
                    param.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue(Utils.GetMimeType(file.Extension));
            ...
            var answerResponse = response.Result.Content.ReadAsStringAsync();
            string answer = answerResponse.Result;
            return answer;
        }

        public static string GetRequest(string url, Dictionary<string, string> urlParams)
        {
        ...
        public static string GetPropValue(string key, string def)
        {
            string value = CrossSettings.Current.GetValueOrDefault(key, def);
            return value;
        }
